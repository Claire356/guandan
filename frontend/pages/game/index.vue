<template>
  <view class="table-page safe-bottom">
    ...
    <view class="game-table">
      <view class="player top"><view class="avatar">AI</view><text>AI-2</text><text class="count">27张</text></view>
      <view class="player left"><view class="avatar">AI</view><text>AI-1</text><text class="count">27张</text></view>
      <view class="player right"><view class="avatar">AI</view><text>AI-3</text><text class="count">27张</text></view>
      <view class="desk-center">
        <text class="desk-label">当前牌面</text>
        <view class="played"><PlayingCard card="♠7" disabled /><PlayingCard card="♥7" disabled /></view>
        <text class="last-play">AI-3 · 对子 7</text>
      </view>
      <view class="turn-pill">轮到你出牌</view>
    </view>
...
.desk-center { position: absolute; left: 50%; top: 47%; transform: translate(-50%,-50%); text-align: center; }.desk-label,.last-play { display: block; font-size: 22rpx; color: rgba(255,255,255,.68); }.played { display: flex; justify-content: center; gap: 10rpx; margin: 16rpx 0; }
