...
class CardTypeRecognitionTests(unittest.TestCase):
    ...
    def test_14_low_ace_straight_is_invalid(self): self.assert_type([14, 15, 3, 4, 5], "invalid", 0)
    ...
    def test_25_five_same_is_not_bomb(self): self.assert_type([7] * 5, "invalid", 0)
    def test_26_six_same_is_not_bomb(self): self.assert_type([8] * 6, "invalid", 0)
    def test_27_seven_same_is_not_bomb(self): self.assert_type([9] * 7, "invalid", 0)
    def test_28_eight_same_is_not_bomb(self): self.assert_type([10] * 8, "invalid", 0)
    def test_29_nine_same_is_not_bomb(self): self.assert_type([11] * 9, "invalid", 0)
    def test_30_ten_same_is_not_bomb(self): self.assert_type([12] * 10, "invalid", 0)
    ...
    def test_33_low_ace_straight_flush_is_invalid(self): self.assert_type([14, 15, 3, 4, 5], "invalid", 0, ["♠"] * 5)
...
class CardTypeComparisonTests(unittest.TestCase):
    ...
    def test_43_four_bomb_beats_straight_flush(self): self.assertEqual(compare(self.result([3] * 4), self.result([10, 11, 12, 13, 14], ["♥"] * 5)), 1)
    def test_44_straight_flush_beats_normal(self): self.assertEqual(compare(self.result([3, 4, 5, 6, 7], ["♠"] * 5), self.result([14])), 1)
    def test_45_higher_four_bomb_wins(self): self.assertEqual(compare(self.result([9] * 4), self.result([8] * 4)), 1)
    def test_46_joker_bomb_is_highest(self): self.assertEqual(compare(identify_card_type(jokers()), self.result([14] * 4)), 1)
    def test_47_long_same_rank_is_invalid(self): self.assertEqual(self.result([9] * 6)["type"], "invalid")
    def test_48_low_ace_straight_is_invalid(self): self.assertEqual(self.result([14, 15, 3, 4, 5])["type"], "invalid")
    def test_49_long_straight_is_valid(self): self.assertEqual(self.result([3, 4, 5, 6, 7, 8])["type"], "straight")
